                ...
                <div className="drawer-side shadow-xl">
                    ...
                    <ul className=" menu flex flex-col bg-[white] justify-center items-center overflow-hidden w-72  p-4 side-bar min-h-full ">
                        ...
                        <div className=" flex flex-col gap-4">
                            ...
                            <li className=" font-syne text-xl"><NavLink to='/dashboard/admin/addPackage'><AiFillAccountBook></AiFillAccountBook><h1>Add Package</h1></NavLink></li>
                            <li className=" font-syne text-xl"><NavLink to='/dashboard/admin/users'><CiBoxList></CiBoxList><h1>Manage Users</h1></NavLink></li>
