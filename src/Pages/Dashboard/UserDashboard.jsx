                ...
                <div className="drawer-side shadow-xl">
                    ...
                    <ul className=" menu flex flex-col bg-[white] justify-center items-center overflow-hidden w-72  p-4 side-bar min-h-full ">
                        ...
                        <div className=" flex flex-col gap-4">
                            <li className=" font-syne text-xl">
                                <NavLink to='/dashboard/profile'><CiUser></CiUser><h1>MY Profile</h1>
                                </NavLink>
                            </li>
                            <li className=" font-syne text-xl">
                                <NavLink to='/dashboard/bookings'><AiFillAccountBook></AiFillAccountBook><h1>booking</h1></NavLink>
                            </li>
                            <li className=" font-syne text-xl">
                                <NavLink to='/dashboard/wishlist'><CiBoxList></CiBoxList><h1>wishlist</h1>
                                </NavLink>
                            </li>
                            <li className=" font-syne text-xl">
                                <NavLink to='/'><CiBoxList></CiBoxList><h1>Home</h1>
                                </NavLink>
                            </li>
                        </div>
