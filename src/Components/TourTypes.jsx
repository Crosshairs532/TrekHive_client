            ...
            <div className=' mt-[6%] '>
                <div className=" grid lg:grid-cols-4 gap-y-2 md:grid-cols-2 grid-cols-1 place-items-center">
                    <Link to={'/tourtypes/hiking'}>
                        <div data-aos="fade-up" data-aos-delay='100' data-aos-duration="3000" className=" tour-type cursor-pointer group relative overflow-hidden w-[300px] h-[400px] ">
                    ...
                    <Link to={'/tourtypes/air'}>
                        <div data-aos="fade-up" data-aos-delay='300' data-aos-duration="3000" className=" tour-type group cursor-pointer  overflow-hidden w-[300px] h-[400px] relative">
                    ...
                    <Link to='/tourtypes/wildlife'>
                        <div data-aos="fade-up" data-aos-delay='500' data-aos-duration="3000" className=" tour-type group cursor-pointer  overflow-hidden w-[300px] h-[400px] relative">
                    ...
                    <Link to={'/tourtypes/sports'}>
                        ...
                        <div data-aos="fade-up" data-aos-delay='700' data-aos-duration="3000" className=" tour-type group cursor-pointer  overflow-hidden w-[300px] h-[400px] relative">
